...
HD_PWD='E:/pack/project_cpu_2/project_final.runs/design_1_rv_pipe_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rv_pipe_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rv_pipe_1_0.tcl
