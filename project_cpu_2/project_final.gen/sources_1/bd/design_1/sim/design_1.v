...
module design_1
  ...
  wire [31:0]rv_pipe_1_dmem_addr;
  wire rv_pipe_1_dmem_en;
  wire [31:0]rv_pipe_1_dmem_wdata;
  wire [3:0]rv_pipe_1_dmem_we;
  wire [31:0]rv_pipe_1_imem_addr;
  wire rv_pipe_1_imem_en;
  ...
  design_1_rv_pipe_1_0 rv_pipe_1
       (.clk(processing_system7_0_FCLK_CLK0),
        .dmem_addr(rv_pipe_1_dmem_addr),
        .dmem_en(rv_pipe_1_dmem_en),
        .dmem_rdata(blk_mem_gen_1_doutb),
        .dmem_wdata(rv_pipe_1_dmem_wdata),
        .dmem_we(rv_pipe_1_dmem_we),
        .imem_addr(rv_pipe_1_imem_addr),
        .imem_en(rv_pipe_1_imem_en),
        .imem_rdata(blk_mem_gen_0_doutb),
